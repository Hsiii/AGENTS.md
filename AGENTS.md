...
- Use `bun`
- When changing CSS, use token instead of hardcodes, keep sizes and spacing in multiples of 4, and check whether the rule is overridden or overrides anything unintended
